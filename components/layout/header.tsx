    ...
    <header className="sticky top-0 z-30 flex h-14 items-center gap-3 border-b border-slate-800 bg-[#080b10]/90 px-4 backdrop-blur">
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <Button
          ...
          onClick={() => queryClient.invalidateQueries({ queryKey: ["csapi"] })}
        >
            ...
            {panel === "notifications" ? (
              <div className="space-y-3">
                ...
                <div className="rounded-md border border-slate-800 bg-slate-950/40 p-3 text-sm text-slate-400">
                  Dados da CS API atualizados via cache de 5 minutos.
                </div>
                <div className="rounded-md border border-slate-800 bg-slate-950/40 p-3 text-sm text-slate-400">
                  Favoritos e analises sao salvos localmente quando Supabase nao esta configurado.
                </div>
              </div>
            ) : (
              <div className="space-y-3">
